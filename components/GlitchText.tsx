...
export default function GlitchText({
  ...
  useEffect(() => {
    ...
    glitchTimeline
      .to('.glitch', { duration: 0.1, skewX: '60', ease: 'power4.inOut' })
  ...
  return (
    <h1 ref={textRef} className={`txt relative ${className} whitespace-nowrap`}>
      <span className="top glitch absolute whitespace-nowrap">{children}</span>
      <span className="bottom glitch absolute whitespace-nowrap">
        {children}
      </span>
